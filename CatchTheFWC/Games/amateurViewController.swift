...
class amateurViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        hideTimer = Timer.scheduledTimer(timeInterval: 0.5, target: self, selector: #selector(hideKupa), userInfo: nil, repeats: true)
    ...
    @objc func countDown() {
        ...
        if counter == 0 {
            ...
            let replayButton = UIAlertAction(title: "Replay", style: UIAlertAction.Style.default) { (UIAlertAction) in
                ...
                self.hideTimer = Timer.scheduledTimer(timeInterval: 0.5, target: self, selector: #selector(self.hideKupa), userInfo: nil, repeats: true)
